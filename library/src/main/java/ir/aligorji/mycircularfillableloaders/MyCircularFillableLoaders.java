package ir.aligorji.mycircularfillableloaders;
...
public class MyCircularFillableLoaders extends AppCompatImageView
{
    ...
    public MyCircularFillableLoaders(final Context context)
    {
        this(context, null);
    }

    public MyCircularFillableLoaders(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public MyCircularFillableLoaders(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.MyCircularFillableLoaders, defStyleAttr, 0);

        // Init Wave
        waveColor = attributes.getColor(R.styleable.MyCircularFillableLoaders_cfl_wave_color, DEFAULT_WAVE_COLOR);
        float amplitudeRatioAttr = attributes.getFloat(R.styleable.MyCircularFillableLoaders_cfl_wave_amplitude, DEFAULT_AMPLITUDE_RATIO);
        amplitudeRatio = (amplitudeRatioAttr > DEFAULT_AMPLITUDE_RATIO) ? DEFAULT_AMPLITUDE_RATIO : amplitudeRatioAttr;
        setProgress(attributes.getInteger(R.styleable.MyCircularFillableLoaders_cfl_progress, 0), false);

        if (attributes.getBoolean(R.styleable.MyCircularFillableLoaders_cfl_border, true))
        {
            float defaultBorderSize = DEFAULT_BORDER_WIDTH * getContext().getResources().getDisplayMetrics().density;
            borderPaint.setStrokeWidth(attributes.getDimension(R.styleable.MyCircularFillableLoaders_cfl_border_width, defaultBorderSize));
        }
        else
        {
    ...
    public void setProgress(int progress, boolean withAnimate)
    {
        ...
        {
            // vertical animation.
            ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(this, "waterLevelRatio", waterLevelRatio, value);
